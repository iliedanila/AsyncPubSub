...
class Broker {
   ...
   private:
    ...
    void defaultCallback(std::string nodeName,
    ...
    std::vector<std::string> getPublishersForSubscription(
    ...
    void sendStopPublish(std::string publisher, std::string subscriber,
                         SubscriptionT subscription);
